function [u,currentColor,pass] = myAItree2level(u,currentColor,pass)
...
[validPosition,value,tempPass] = mypositionvalue(u,currentColor,0);
% plotgame(u);
...
for i = 1:length(validPosition)
    ...
    [tempPosition,tempValue,tempPass] = mypositionvalue(tempu,tempColor,0);
%     figure(1); clf; 
%     plotgame(tempu); 
